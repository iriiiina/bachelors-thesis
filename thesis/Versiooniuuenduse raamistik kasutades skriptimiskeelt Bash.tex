...
\begin{document}
  ...
  \begin{itemize}
    \item Projekt kasutab kaks erinevat veebiserverit: Apache Tomcat 8 ja Oracle WebLogic 12. 
    \item Teavtamise süsteem
    \item Tegelevad testijad
    \item Ühe ja mitmete moodulite uuendus
    \item kahe serverite uuendus
  \end{itemize}
